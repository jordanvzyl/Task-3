...
namespace Jordan_van_Zyl___18013347___GADE_A3
{
    ...
    public class ReconUnit : Unit
    {
        // MeleeUnit constructor that inherits from Unit class
        public ReconUnit(string name, int pos_X, int pos_Y, int health, int maxHealth, int speed, int attack, int attackRange, string team, string symbol, bool isAttacking) : base(name, pos_X, pos_Y, health, maxHealth, speed, attack, attackRange, team, symbol, isAttacking)
        {
        ...
        public override string toString()
        {
            string reconUnit = "";
            reconUnit += "Name: " + Name + "\n" + "X-Coordinate: " + Pos_X + "\n" + "Y-Coordinate: " + Pos_Y + "\n";
            reconUnit += "Health: " + Health + "\n" + "Speed: " + Speed + "\n" + "Attack: " + Attack + "\n";
            reconUnit += "Attack Range: " + AttackRange + "\n" + "Team: " + Team + "\n" + "Symbol: " + Symbol + "\n" + "Attacking: " + IsAttacking + "\n";
            return reconUnit;
        }
        ...
        public override void Save()
        {
            ...
            FileStream file = new FileStream("saves/ReconUnit.file", FileMode.Append, FileAccess.Write);
