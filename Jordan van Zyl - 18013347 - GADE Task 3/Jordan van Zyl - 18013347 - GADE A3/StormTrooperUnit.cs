...
{
    public class StormTrooperUnit : Unit
    {
        // MeleeUnit constructor that inherits from Unit class
        public StormTrooperUnit(string name, int pos_X, int pos_Y, int health, int maxHealth, int speed, int attack, int attackRange, string team, string symbol, bool isAttacking) : base(name, pos_X, pos_Y, health, maxHealth, speed, attack, attackRange, team, symbol, isAttacking)
        {
        ...
        public override void Save()
        {
            ...
            FileStream file = new FileStream("saves/StormTrooperUnit.file", FileMode.Append, FileAccess.Write);
