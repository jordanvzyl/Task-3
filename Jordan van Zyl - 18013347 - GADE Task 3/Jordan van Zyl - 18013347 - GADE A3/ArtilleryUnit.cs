...
namespace Jordan_van_Zyl___18013347___GADE_A3
{
    public class ArtilleryUnit : Unit
    {
        ...
        public ArtilleryUnit(string name, int pos_X, int pos_Y, int health, int maxHealth, int speed, int attack, int attackRange, string team, string symbol, bool isAttacking) : base(name, pos_X, pos_Y, health, maxHealth, speed, attack, attackRange, team, symbol, isAttacking)
        {
        ...
        public override void Save()
        {
            ...
            FileStream file = new FileStream("saves/ArtilleryUnit.file", FileMode.Append, FileAccess.Write);
